          ...
          <div className="card">
            <div className="card-title" style={{marginBottom:8}}>
              ...
              <InfoTooltip
                ...
                sections={[
                  { label: 'What it shows', body: 'A composite 0–100 score per active client reflecting both relationship strength and competitive exposure. Shown alongside revenue and wallet context.' },
                  { label: 'Scoring model', body: 'Baseline 50. Six factors adjust the score:\n\n① Revenue level: +20 (>£500K) · +10 (£200–500K) · 0 (£50–200K) · −10 (<£50K)\n② Matter diversity (open matters): +20 (3+ areas) · +10 (2 areas) · −10 (1 area)\n③ Partner breadth (open or active last 24 months): +15 (3+) · +10 (2) · −5 (1)\n④ Share of wallet: +10 (≥50%) · 0 (25–49%) · −10 (10–24%) · −20 (<10%) — halved if estimate confidence is Low\n⑤ Competitor practice foothold: +5 (no gaps) · −5 (competitors present, spend <50% of ours) · −12 (competitor spend 50–150% of ours) · −20 (competitor spend >150% of ours)\n⑥ Recent competitive signals (last 12 months): −15 (High severity) · −8 (Medium) · −3 (Low)\n\nFactors ④–⑥ are capped at a combined −25 penalty. Final score clamped to [0, 100].' },
                  { label: 'Bands', body: 'Healthy ≥ 70: deep, diversified relationship with no major competitor threat\nWatch 50–69: narrowing engagement or emerging competitor presence — worth a check-in\nAt Risk < 50: single-partner or single-practice, low share of wallet, or active competitive threat — churn candidate' },
                  { label: 'Why competitors reduce the score', body: 'A client instructing three other firms across practice areas we don\'t serve is already partially lost. Share of wallet below 10% means we are a minor supplier in their eyes, not a trusted adviser. These are leading indicators of relationship drift that revenue figures won\'t yet show.' },
                  { label: 'Why it beats revenue tracking', body: 'Revenue decline is a LAGGING indicator — by the time it shows, the relationship problem is 6–12 months old. Matter diversity thinning, partner count dropping, and competitor encroachment are LEADING signals. This score is designed to flag them before they hit the P&L.' },
                  { label: 'Action', body: 'At Risk + high revenue: partner outreach this week.\nWatch + large wallet gap + known competitors: treat as a growth defence call, not just relationship maintenance.\nHealthy + low share of wallet: cross-sell opportunity — the client trusts us but is spending elsewhere.' },
                ]}
              />
            </div>
            <p style={{color:'var(--text-muted)',fontSize:'0.82rem',marginBottom:16}}>

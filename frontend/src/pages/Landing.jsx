        ...
        <div style={{maxWidth:1100,margin:'0 auto'}}>
          ...
          <div className="features-grid" style={{gridTemplateColumns:'repeat(auto-fit, minmax(300px, 1fr))',marginBottom:40}}>
            {[
              ...
              { scope: 'enhancement', icon: <Heart size={20} />, color: 'red', title: 'Client Health Score', desc: 'Composite 0-100 score (revenue trend + matter diversity + partner breadth + recency + payment behaviour). Early warning before a client goes quiet.', where: 'Client Intelligence → Health', to: '/clients' },
